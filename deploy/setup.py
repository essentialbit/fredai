...
def print_final_message(port=8080):
    ...
    print()
    print(c("Y", "  First run: the admin account's password is randomly generated and"))
    print(c("Y", "  printed ONCE — check the terminal/console output from FredAI's first"))
    print(c("Y", f"  start (or {LOGS_DIR / 'fredai.log'} if running as a service), or set"))
    print(c("Y", "  FREDAI_ADMIN_PASSWORD in .env beforehand to pin a specific password."))
    print()
